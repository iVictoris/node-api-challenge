...
-   [ ] Mention two parts of Express that you learned about this week.
        nada unfortunately because I finished this unit 3 months ago
-   [ ] Describe Middleware?
        a function that intercepts a request and may modify the request obj or do some additional tasks or do nothing

-   [ ] Describe a Resource?
        data you can get by calling a specific endpoint if it is supported

-   [ ] What can the API return to help clients know if a request was successful?
        status --> 2xx

-   [ ] How can we partition our application into sub-applications?
        use Express.Router which then becomes mini apps
